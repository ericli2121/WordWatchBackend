...
app.get('/api/extract', async (req, res) => {
  ...
  try {
    ...
    // Try youtube-caption-extractor first (unless ytdl method is specifically requested)
    if (method !== 'ytdl') {
      try {
        ...
        result = {
          ...
          data: {
            ...
            note: 'youtube-caption-extractor failed, used ytdl-core as fallback'
          }
        };
      }
    } else {
...
app.get('/', (req, res) => {
  res.json({
    ...
    parameters: {
      ...
      method: 'Extraction method: "ytdl" for ytdl-core, or omit for auto-fallback'
    },
    examples: [
    ...
    note: 'youtube-caption-extractor has limitations with automatic translated subtitles. Use method=ytdl for better support.'
  });
});
